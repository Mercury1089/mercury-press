<?php if (is_front_page()) { // Front page hero ?>
    <header class="hero hero--parallax hero--full-height">
...
<?php } else if ( is_home() ) { // Blog feed hero ?>
    <header class="hero hero--parallax">
...
?>
    ...
    <?php } else { ?>
        <header class="hero hero--parallax hero--small-height">
    <?php } ?>
...
<?php } else if ( is_post_type_archive( 'robot' ) ) { // Archive robot page hero ?>
    <header class="hero hero--parallax hero--medium-height">
