<nav class="nav nav--transparent">
    ...
    <?php 
        class NavWalker extends BEMWalkerNavMenu {
            ...
            protected $navLinkClass = 'nav-menu__sub-item nav-menu__sub-item--type--anchor';
            protected $subNavClass = 'nav-menu__sub-item nav-menu__sub-item--type--menu';
            protected $subNavItemClass = 'nav-sub-menu__item';
            protected $subNavLinkClass = 'nav-sub-menu__item nav-sub-menu__item--type--anchor';
        }
        wp_nav_menu( array(
