<?php get_header(); ?>
    <section class="landing-section landing-section--grabber"> <!-- Grabber text -->
    ...
    <section class="landing-section landing-section--light landing-section--sponsorbg"> <!-- "SPONSORS" -->
        ...
        <a href="#" class="button landing-section__button">SPONSOR US</a>
    </section>
    <section class="landing-section"> <!-- "JOIN US" -->
        <h2 class="landing-section__header">JOIN US</h2>
        <p class="landing-section__text-body" id="call">
        ...
        <a href="#" class="button landing-section__button">SIGN UP</a>
    </section>
<?php get_footer(); ?>